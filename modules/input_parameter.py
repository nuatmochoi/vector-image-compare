...
# add_option_str(parser, "--model-id", defaults="amazon.titan-embed-text-v1")
#add_option_str(parser, "--model-id", defaults="cohere.embed-multilingual-v3")
add_option_str(parser, "--model-id", defaults="amazon.titan-embed-text-v2:0")

add_option_str(parser, "--dog-target-key", defaults="Negative")
add_option_str(parser, "--cat-target-key", defaults="Positive")
