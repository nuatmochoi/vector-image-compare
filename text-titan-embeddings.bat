...
SET VAL=
SET VAL=%VAL% 'embeddings_pickle_file': 'text2-embeddings.pkl',
SET VAL=%VAL% 'index_mask_pickle_file': 'text2-index-mask.pkl',
SET VAL=%VAL% 'create_args_cat_csv_file': 'yes_data.csv',
SET VAL=%VAL% 'create_args_dog_csv_file': 'no_data.csv',
SET VAL=%VAL% 'model_id': 'amazon.titan-embed-text-v1',
